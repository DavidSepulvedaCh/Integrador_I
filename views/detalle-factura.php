...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
			...
			$consul="SELECT * FROM detalle_venta,items WHERE detalle_venta.id_producto=items.id AND detalle_venta.id_venta='$bs'";
            ?>
            ...
            <div>
				<table class="table">
					...
					<?php $total=0; ?>
					<?php $resultado = mysqli_query($cnx, $consul);
					...
					<tr>
						<td colspan="5" align="right"><h3><b>TOTAL</b></h3></td>
