    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            $rta = mysqli_query($cnx, $sql);
                ...
                header("location:client-buscar.php");
            }
            ?>
            <center>
                <br>
                <h2>BUSQUEDA DE CLIENTE</h2>
                <p class="parrafo">Bienvenido al modulo de busqueda de cliente para la empresa Auto-LUXUA; para buscar un cliente por favor ingrese el numero de cedula. A continuacion se mostrara la informacion relacionada a ese cliente.   </p>
                    <div>
