    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <center>
                <br>
                <h2>NUEVA FACTURA</h2>
				<p class="parrafo">Bienvenido al apartado para generar una nueva factura de venta para la empresa Auto-Luxua. Por favor ingrese el ID relacionado al producto que desea agregar a la factura.</p>
