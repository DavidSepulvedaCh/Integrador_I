...
$client = "SELECT * FROM clientes ORDER BY nombre ASC";
...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<h2 class="parrafo">A continuacion el listado de clientes registrados en la base de datos de la empresa</h2>
			<div>
				<table class="table">
					<tr>
						<td><b>NOMBRE</b></td>
					...
					<?php $resultado = mysqli_query($cnx, $client);
