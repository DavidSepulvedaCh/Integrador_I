...
$items = "SELECT * FROM usuarios ORDER BY nombre ASC";
...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <!-- Page header -->
			<h2 class="parrafo">A continuación los usuarios que estan registrados en la empresa</h2>
            <div>
				<table class="table">
					<tr>
						<td><b>NOMBRE</b></td>
					...
					<?php $resultado = mysqli_query($cnx, $items);
