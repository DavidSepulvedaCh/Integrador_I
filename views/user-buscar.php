    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <center>
                ...
                <p class="parrafo">Bienvenido al modulo de busqueda de usuario para la empresa Auto-LUXUA; para buscar un usuario por favor ingrese el numero de cedula.</p>
                    <div>
                        <form action="./user-search.php" method="post">
                            <input class="buscar_cl" type="text" name="buscar_cl" id="buscar_cl" required>
