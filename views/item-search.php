...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            $id=$_POST['id'];
            $sql = "SELECT id, nombre, descripcion, stock as p
                    FROM items
                    WHERE '$id' = id
            ...
            <center>
                <br>
                <h2>BUSQUEDA DE ITEM</h2>
                <p class="parrafo">Bienvenido al modulo de busqueda de item para la empresa Auto-LUXUA; para buscar un item por favor ingrese el ID de este.</p>
                    <div>
                        <form action="./item-search.php" method="post">
                            <input type="text" class="buscar_cl" name="id" id="id" required>
